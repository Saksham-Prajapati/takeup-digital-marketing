                    ...
                    <div className="col-xl-4 col-lg-12">
                        <div className="tekup-footer-textarea light-color">
                            ...
                            <div className="tekup-footer-info">
                                <ul>
                                    <li><Link href="tel:123"><i className="ri-phone-fill" />+919220422880</Link></li>
                                    <li><Link href="mailto:name@email.com"><i className="ri-mail-fill" />support@hexbytes.in</Link></li>
                                </ul>
                            </div>
                        </div>
                    </div>
